...
public class Stepdefs {
    ...
    public void aValidUsernameAndPasswordAndNonmatchingPasswordConfirmationAreEntered(String username, String password) throws Throwable {
        registerWith(username, password, "z" + password);
    }

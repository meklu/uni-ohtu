...
public class KassapaateTest {
    ...
    @Test
    public void latausLataaPositiivisenSumman() {
        kassa.lataa(kortti, 14);

        verify(kortti, times(1)).lataa(eq(14));
        verify(kortti).lataa(eq(14));
    }

    @Test
    public void latausEiLataaNegatiivistaSummaa() {
